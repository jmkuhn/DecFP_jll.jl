...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import DecFP_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("47200ebd-12ce-5be5-abb7-8e082af23329"))
platforms = [Pkg.Artifacts.unpack_platform(e, "DecFP", artifacts_toml) for e in artifacts["DecFP"]]
...
if best_platform === nothing
    @debug("Unable to load DecFP; unsupported platform $(triplet(platform_key_abi()))")
else
